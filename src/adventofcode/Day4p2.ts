export class Day4p2 {
	...
	public static checkNumOfValidPasswords(input: string): number {
		let invalidNo = 0;
	...
	private static isAnagram(str1: string, str2: string): boolean {
		return str1.split('').sort().join('') === str2.split('').sort().join('');
	}

}

console.log(Day4p2.checkNumOfValidPasswords('oaoe rxeq vssdqtu xrk cjv yaoqp loo\n' +
